...
# Exercise 1.04
#def index(reqquest):
#    name = reqquest.GET.get("name") or "world"
...
#    return render(request, "search-results.html", {"search_word": search_word})
...
def review_edit(request, book_pk, review_pk=None):
    ...
    return render(request, "reviews/instance-form.html",{"form": form, "instance": review, "model_type": "Review", "related_instance": book, "related_model_type": "Book"})
